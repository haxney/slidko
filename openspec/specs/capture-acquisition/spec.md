...
TBD — captures live logic-analyzer acquisition via `sigrok-cli` subprocess
orchestration: command construction, device/driver error surfacing, hardware
isolation from the test suite, and regenerable real-file validation fixtures.
