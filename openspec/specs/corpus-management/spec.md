...
Tooling for the bench corpus that IS the test suite: schema-validated
sidecars pairing raw .sr captures with ground truth, one-motion labeled
capture, sweep-cell curves for degradation analysis, and a held-out
field-gold set that is never tuned against.
