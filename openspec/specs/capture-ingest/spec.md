...
TBD — captures reading and writing of sigrok `.sr` session files into
`Capture` objects, including multi-chunk reassembly, non-byte-multiple
channel handling, round-trip fidelity, and provenance metadata.
