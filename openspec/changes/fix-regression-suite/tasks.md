...
- [ ] 10.2 `.venv/bin/python -m pytest -q` reports zero failures across the ENTIRE suite (not just touched files) — this is the actual acceptance bar for this change
