def test_sweep_cell_functionality():
    """Test that a cell.json with axis="length_m", values=[1,5,10] produces three entries,
    each sidecar carrying sweep_cell.axis="length_m" and its own value; entries group cleanly by (cell, axis)"""
