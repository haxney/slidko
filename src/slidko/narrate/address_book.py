...
_ADDRESS_BOOK = {
    ...
    0x1E: [
        {"part": "HMC5883L", "kind": "Magnetometer", "note": "Magnetometer"}
    ],
    0x29: [
        {"part": "VL53L0X", "kind": "ToF distance sensor", "note": "Time-of-Flight distance sensor"}
    ],
    0x3C: [
    ...
    0x40: [
        ...
        {"part": "PCA9685", "kind": "PWM/servo driver", "note": "16-channel PWM controller"},
        {"part": "Si7021", "kind": "Humidity sensor", "note": "Humidity/temperature sensor"}
    ],
    0x41: [
        {"part": "INA219", "kind": "Current sensor", "note": "Current/power monitor"},
        {"part": "INA226", "kind": "Current sensor", "note": "Current/power monitor"},
    ...
    0x12: [
        {"part": "PMSA003I", "kind": "Particulate sensor", "note": "Particulate matter sensor"}
    ]
}
